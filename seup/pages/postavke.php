...
// === Card: Klasifikacijske oznake (skraćeni front, isti kao tvoj) ===
print '<div class="seup-settings-card seup-card-wide">';
print '<div class="seup-card-header"><div class="seup-card-icon"><i class="fas fa-sitemap"></i></div><h3 class="seup-card-title">Klasifikacijske Oznake</h3><p class="seup-card-description">Upravljanje sustavom klasifikacije</p></div>';
...
print '<div class="seup-card-header"><div class="seup-card-icon"><i class="fas fa-users"></i></div><h3 class="seup-card-title">Interne Oznake Korisnika</h3><p class="seup-card-description">Upravljanje korisničkim oznakama i radnim mjestima</p></div>';
print '<form method="post" action="'.$_SERVER['PHP_SELF'].'" class="seup-form">';
...
print '<div class="seup-settings-card">';
print '<div class="seup-card-header"><div class="seup-card-icon"><i class="fas fa-building"></i></div><h3 class="seup-card-title">Oznaka Ustanove</h3><p class="seup-card-description">Osnovni podaci o ustanovi i njena identifikacijska oznaka</p></div>';
...
print '<div class="seup-settings-card seup-card-wide">';
print '<div class="seup-card-header"><div class="seup-card-icon"><i class="fas fa-users"></i></div><h3 class="seup-card-title">Treće Osobe</h3><p class="seup-card-description">Suradnici i treće osobe</p></div>';
...
// Footer
print '<footer class="seup-footer"><div class="seup-footer-content"><div class="seup-footer-left"><p>Sva prava pridržana © <a href="https://8core.hr" target="_blank" rel="noopener">8Core Association</a> 2014 - '.date('Y').'</p></div><div class="seup-footer-right"><p class="seup-version">SEUP v.14.0.4</p></div></div></footer>';
print '</main>';
